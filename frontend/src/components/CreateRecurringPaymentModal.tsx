        ...
        <div className="bg-zinc-900 border border-zinc-700 rounded-2xl p-6 w-full max-w-lg max-h-[90vh] overflow-y-auto">
          ...
          <div className="space-y-4">
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              <div>
                <label htmlFor="recurring-amount" className="text-xs text-zinc-400 block mb-1.5">
            ...
            <div className="grid gap-3 sm:grid-cols-3">
              ...
              <div>
                <label htmlFor="recurring-end" className="text-xs text-zinc-400 block mb-1.5">
            ...
            {kind === "FixedAmountPerPeriod" && (
              <div>
                <label htmlFor="recurring-cap" className="text-xs text-zinc-400 block mb-1.5">Cap (optional total)</label>
                <input
                  id="recurring-cap"
                  value={cap}
            ...
            {error && (
              <p className="text-xs text-red-400 bg-red-500/10 rounded-lg px-3 py-2" role="alert">{error}</p>
            )}
